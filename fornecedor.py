...
def cadastro_forn():
    ...
    def RegistrarNoBanco():
        conn = conectar_banco()
        cursor = conn.cursor()
        cursor.execute("INSERT INTO fornecedor (nome, nomefantasia, CNPJ, endereco) VALUES (%s, %s, %s, %s)", (fornomeEntry, ficticioEntry, cnpjEntry, endEntry)) #Insere os dados do usuário na tabela
