...
class Menuadm:
    def __init__(self, root):
        ...
        # Frame para os botões (3 colunas)
        ...
        botoes = [
            {
                "texto": "Funcionários",
                "descricao": "Tela de funcionários\nVocê pode cadastrar, listar, excluir\n"
                             "e pesquisar os funcionários da nossa biblioteca",
                "comando": self.TelaFuncionarios
            },
            {
                "texto": "Fornecedores",
                "descricao": "Aqui você pode cadastrar,\nlistar, excluir "
                             "e pesquisar\nos nossos fornecedores",
                "comando": self.TelaFornecedores
            },
            {
                "texto": "Produtos",
                "descricao": "Na tela de produtos você pode\n"
                             "cadastrar, listar, excluir\n"
                             "e pesquisar os produtos",
                "comando": self.TelaProdutos
            },
        ]

        for i, botao in enumerate(botoes):
            btn = ctk.CTkButton(frame_botoes, text=botao["texto"], width=180, command=botao["comando"])
            ...
            desc.grid(row=1, column=i, padx=20, pady=(0, 20))
    ...
    def CriarUsuario(self):
        ...
        campos = [
            ("Usuário:", "UserNomeEntry"),
            ("Senha:", "SenhaEntry", True),
            ("Nome Completo:", "UserNomeCEntry"),
            ("E-mail:", "EmailEntry"),
        ]
